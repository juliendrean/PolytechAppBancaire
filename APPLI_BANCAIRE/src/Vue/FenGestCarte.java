...
public class FenGestCarte extends JFrame {
	...
	public void setLabelNumCarte(String string)
	{
		this.jLabelNumCmpt.setText(new Integer(string).toString());
	}
